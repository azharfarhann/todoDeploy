...
const Home = () => {
  ...
  const fetchTodos = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`${apiUrl}/private/todos`, {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${apiUrl}/private/deletetodo/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchTodos();
    } catch (error) {
  ...
  const handleDeleteAll = async () => {
    setLoading(true);
    try {
      await axios.delete(`${apiUrl}/private/deletealltodo`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchTodos();
    } catch (error) {
  ...
  const handleEditTodo = async () => {
    try {
      await axios.put(
        `${apiUrl}/private/updatetodo/${editTodo._id}`,
        { title: form.title, description: form.description },
        {
          headers: { Authorization: `Bearer ${token}` },
        }
